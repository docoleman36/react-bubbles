...
A token is what grants a user access and can be used to identify if it is granted or not. Usually tokens are used for signing in. 

- [ ] What steps can you take in your web apps to keep your data secure?

Using OAuth2 istead of LocalStorage helps keeps data secure. 

- [ ] Describe how web servers work.

Web servers are a program that uses HTTP to serve the files that for web pages to users.
